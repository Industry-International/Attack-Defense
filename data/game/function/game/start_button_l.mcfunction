execute if score state game_state matches 0 if score CTD game_start_ctd matches 140 at @a run function game:sounds/exp_orb_pickup
...
execute if score CTD game_start_ctd matches 120 at @a run function game:sounds/click_button
execute if score CTD game_start_ctd matches 120 run title @a title {"text":"5","color":"gold","bold":true}
execute if score CTD game_start_ctd matches 100 at @a run function game:sounds/click_button
execute if score CTD game_start_ctd matches 100 run title @a title {"text":"4","color":"gold","bold":true}
execute if score CTD game_start_ctd matches 80 at @a run function game:sounds/click_button
execute if score CTD game_start_ctd matches 80 run title @a title {"text":"3","color":"gold","bold":true}
execute if score CTD game_start_ctd matches 60 at @a run function game:sounds/click_button
execute if score CTD game_start_ctd matches 60 at @a run title @a title {"text":"2","color":"gold","bold":true}
execute if score CTD game_start_ctd matches 40 at @a run function game:sounds/click_button
...
execute if score CTD game_start_ctd matches 20 at @a run function game:sounds/levelup
